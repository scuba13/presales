  ...
  static getProviderInfo(provider: AIProvider): {
    ...
    const info = {
      ...
      openai: {
        name: 'OpenAI GPT',
        model: 'gpt-5',
        description: 'Modelos GPT-5 da OpenAI - Última geração',
        models: [
          {
            id: 'gpt-5',
            name: 'GPT-5',
            description: '🚀 Máxima capacidade e inteligência',
          },
          {
            id: 'gpt-5-mini',
            name: 'GPT-5 Mini',
            description: 'Balanceado - Excelente custo-benefício',
          },
          {
            id: 'gpt-5-nano',
            name: 'GPT-5 Nano',
            description: 'Otimizado - Velocidade e economia',
          },
        ],
      },
    };
